...
const Projects = () => {
    const all_projects=[
        ...
        {id:3,title:"CRM Module",image:CRMModuleImage,type:"Full Stack Project",description:"Role-based CRM platform built with Laravel API and React.js, featuring secure authentication for Admin, Sales, and Support users, management of leads, customers, deals, and tickets, a ticketing system with status tracking and activity logs, and responsive role-specific dashboards for efficient CRM workflows.",sourcecode:"https://github.com/MohamedMoamen/CRM_Module",hideDemo:true},
        {id:4,title:"Multi-Tenant School Management System",image:Multitenant_School_Management_System,type:"Backend Project",description:"SaaS school management system built in Laravel using Blade templating, featuring multi-tenant architecture with record-level tenant_id isolation, and a secure admin panel enabling efficient management of teachers, students, courses, and enrollments across multiple schools within a shared database.",sourcecode:"https://github.com/MohamedMoamen/multitenant_school_management_system_app",hideDemo:true},
        {id:5,title:"E-commerce Web Application",image:E_commerceImage,type:"Frontend Project",description:"Built an interactive and fully functional e-commerce shopping cart using React. The application allows users to browse products, add or remove items from the cart , update quantities, and view dynamic totals. It features a responsive UI optimized for all screen sizes and includes essential e-commerce functionality.",link:"https://e-commerce-website-cyan-sigma.vercel.app/",sourcecode:"https://github.com/MohamedMoamen/E-commerceWebsite"},   
        {id:6,title:"Admin Dashboard Web Application",image:AdminDashboardImage,type:"Frontend Project",description:"Developed an interactive dashboard for data visualization and management using React.js and Syncfusion Charts. Implemented multiple chart types, dynamic state management with Context API, responsive design with Tailwind CSS.",link:"http://admin-dashboard-app-opal.vercel.app/",sourcecode:"https://github.com/MohamedMoamen/Admin-Dashboard-App"},
        {id:7,title:"Todo List Application",image:TodoListImage,type:"Frontend Project",description:"A dynamic web application developed using React.js, designed to help users efficiently organize and track their daily tasks by adding, editing and deleting tasks. the application focuses on providing a seamless user experience and robust task management functionalities, and a fully responsive design across all screen sizes.",link:"https://todo-list-eta-teal.vercel.app/",sourcecode:"https://github.com/MohamedMoamen/TodoList"},
        {id:8,title:"Weather Forecast Application",image:WeatherForecastImage,type:"Frontend Project",description:"A responsive web application that displays real-time weather data by fetching live forecasts from an external API. Built with React and optimized for both desktop and mobile screens, and supports both Arabic and English languages.",link:"https://weather-forecast-zeta-nine.vercel.app/",sourcecode:"https://github.com/MohamedMoamen/WeatherForecast"}
    ]
